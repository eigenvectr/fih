...
const REFERENCE: { title: string; body: string }[] = [
  {
    title: "If the warden pulls us over — the NY legal checklist",
    body: "Verified against NY law for our class (16–26 ft motorboat), Aug 2026. ON BOARD ALWAYS: (1) a USCG wearable life jacket per person, right size, readily accessible — kids under 12 WEAR theirs, and Nov 1–May 1 EVERYONE wears one on a boat under 21 ft (our fall salmon trips); (2) a Type IV throwable cushion or ring, in reach; (3) marine B-1 fire extinguisher — gauge green, under 12 years old; (4) whistle or horn (mouth whistle counts); (5) three unexpired handheld red flares (42-month stamp) PLUS a fluorescent-orange distress flag ≥1 ft square — NY requires both; (6) working nav lights, on sunset to sunrise; (7) bow numbers + sticker displayed and the ORIGINAL registration certificate on board. PAPERWORK: Brianna's Law — since Jan 1, 2025 every operator, any age, must carry a NY boating safety certificate (~8-hr course, ~$30–50, lifetime). Anyone who drives the boat needs their own, dad included. Not applicable to us: flame arrestor and ventilation (inboard-only rules). Dry-box audit each spring: jackets counted for the day's crew, flare dates, extinguisher gauge, registration card, certificates.",
  },
  {
    title: "Stuck seat post — the removal ladder",
    body: "CONFIRMED (stamp on the seat plate): Springfield KingPin system — 7×7 deck plate, nylon bushing, ¾\" STEEL pin with a spring and a split-nylon retention clip at the tip. Not threaded, not locked: our stuck one is RUST-WELDED — the steel pin rusted inside the bushing (rust expands, same moisture story as the humid stern). Attack order: (1) Penetrant aimed at the rust: flood the top of the bushing, 30+ min dwell (overnight for bad ones), reapply. (2) Twist-and-pull: padded pipe wrench, rotate back and forth to crack the bond while a helper pulls straight up — the first slight movement wins the battle; keep working it. (3) Heat gun on the BASE/bushing only, never the pin (expands tighter); upward hammer blows on low-clamped vise-grips — never down or sideways, no crowbar against the deck. (4) Guaranteed finisher: back out the six plate screws, lift plate+post as one, flip it, punch the pin out through the base's underside on a bench. Aftermath: wire-brush the pin to bare metal (badly pitted = replace the seat-side mount, ~$25), new retention clip (Springfield 2100175, ours is chewed) and bushing if scored (2100055), then WAX or dry-lube the pins a few times a season — never grease, and keep the hatches-open humidity routine going so the next rust weld never starts.",
  },
  {
