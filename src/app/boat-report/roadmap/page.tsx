...
const ROADMAP: {
    ...
    parts: [
      {
        ...
        pick: "The cover was part of the deal, and the boat as-sold had the Ulterra on the bow. A cover that can't go over that motor never fit the boat they sold. The ask (queued Aug 2026): swap it for the trolling-motor-cut version, or have their upholstery guy add a bow pocket to this one. Bundle with the impeller booking for an easy yes. Update Aug 2026: no tag found on the cover; Chris's invoice is the only record of what was bought. Chris's first answer was a quick-release bracket link (the solution that costs him nothing) — countered by text: declined the QR route, named Shoretex's Pro-185 trolling-motor pattern and Carver's equivalent as proof the right cover exists, re-asked for the swap or the upholstery-guy bow pocket, re-asked the cover model, and tied it to the impeller booking. Final offer sent: return this cover and order the trolling-motor version, Edward covers the price difference and throws in the traded Mirrocraft's mooring cover (helps Chris resell it). Fallback if he balks: the upholstery-guy pocket mod at cost. Spend nothing until this lands.",
        cost: "$0 ask",
      },
      {
  ...
  },
  {
    ...
    details: [
      "HARD LIMIT, verified in Tesla's manual: the Model Y ball mount may be at most 8.5\" long with at most a ¾\" (0.75 in) rise — no taller. Reason: the hitch hides inside the rear crash structure, certified for tongue loads near the receiver's centerline; a tall rise levers on it and can also crack the bumper fascia under articulation. The common flip-style \"2-inch drop / ¾-inch rise\" mount used rise-up IS the legal maximum.",
      "THE PART, verified: CURT 45534 Towing Starter Kit (~$45–60) — 8¼\" long (under the 8.5\" cap), ¾\" rise flipped, 2\" ball included, 7,500-lb rated, ships with pin, clip, and lock. etrailer has filmed it installed on a Model Y; it's the standing Tesla-forum pick. Note: the ball comes torqued for drop orientation — flipping to rise means unbolting and re-torquing the ball on the other face (~250 ft-lbs). Tool reality: the nut is a 1½\" hex — bigger than anything in the Anvil set — and the M12 ratchet tops out ~40 ft-lbs, a sixth of spec. DIY route (bought Aug 2026): Reese Towpower 74342 hitch ball wrench, whose 1½\" end fits the nut. Method: pin the mount in the receiver so it can't spin, break the nut loose (cheater pipe if stubborn), flip, keep the lock washer, retighten with full body weight on the wrench, paint a witness mark, re-check after the first tow. Fallback stays free: any tire shop's impact gun.",
      "Sizing check, done in the driveway: hook up with the ¾\" rise mount and real tongue weight, then eyeball the trailer's attitude. Modestly nose-HIGH is acceptable on a short single-axle boat trailer (never nose-down). If it's badly nose-high, the remaining fix is trailer-side — a taller coupler mount or coupler swap at a trailer shop ($50–150) — not a bigger rise on the car.",
      "THE COUPLING FIX (no deadlifting, ever): the tongue jack does all the lifting — crank the coupler above the ball, back the ball under, crank down onto it. Ours bottoms out before ball height, which is a jack-POSITION problem: loosen the two clamp bolts holding the swivel jack to the tongue, slide the whole jack tube UP an inch or two, retighten — fully-retracted now sits the coupler that much lower. If the clamp is maxed, a longer-travel swivel jack is $40–60 and swaps on the same bolts.",
